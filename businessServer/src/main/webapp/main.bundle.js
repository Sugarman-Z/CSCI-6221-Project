...
module.exports = "<div>\n  <h3><span class=\"icon-uniE18E\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> Online Recommendation</h3>\n  <p class=\"descri\">Guess you like... <a [routerLink]=\"['/explore', { type: 'guess' }]\" >More...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let streamProduct of streamProducts\"><app-thumbnail [product]=\"streamProduct\"></app-thumbnail></div>\n    </div>\n  </div>\n\n  <h3><span class=\"glyphicon glyphicon-heart\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> Offline Recommendation</h3>\n  <p class=\"descri\">New added <a [routerLink]=\"['/explore', { type: 'offline' }]\" >More...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let offlineProduct of offlineProducts\"><app-thumbnail [product]=\"offlineProduct\"></app-thumbnail></div>\n    </div>\n  </div>\n\n  <h3><span class=\"icon-whatshot\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> Trending</h3>\n  <p class=\"descri\">System Recommend <a [routerLink]=\"['/explore', { type: 'hot' }]\" >More...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let hotProduct of hotProducts\">\n        <app-thumbnail [product]=\"hotProduct\"></app-thumbnail>\n      </div>\n    </div>\n  </div>\n\n  <h3><span class=\"glyphicon glyphicon-star\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> Top Rated</h3>\n  <p class=\"descri\">In order to improve the Recommendation, please rate more products <a [routerLink]=\"['/explore', { type: 'rate' }]\" >More...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let rateMoreProduct of rateMoreProducts\"><app-thumbnail [product]=\"rateMoreProduct\"></app-thumbnail></div>\n    </div>\n  </div>\n\n</div>\n"
...
var LoginService = (function () {
    ...
    LoginService.prototype.login = function (user) {
        ...
        this.http
            ...
            _this.data['message'] = 'Service Error！';
        });
    };
